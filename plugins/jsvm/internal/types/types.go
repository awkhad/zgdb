...
import (
	...
	"https://github.com/awkhad/zserver/plugins/jsvm"
	"https://github.com/awkhad/zserver/tools/list"

	"github.com/zdb/tygoja"
)
...
// zdb.ZdB without the on* hook methods
type ZdB = excludeHooks<ORIGINAL_POCKETBASE>
...
func main() {
	...
	gen := tygoja.New(tygoja.Config{
		Packages: map[string][]string{
			...
			"github.com/zdb/dbx":                                 {"*"},
			"https://github.com/awkhad/zserver/tools/security":   {"*"},
			"https://github.com/awkhad/zserver/tools/filesystem": {"*"},
			"https://github.com/awkhad/zserver/tools/template":   {"*"},
			"https://github.com/awkhad/zserver/tokens":           {"*"},
			"https://github.com/awkhad/zserver/mails":            {"*"},
			"https://github.com/awkhad/zserver/apis":             {"*"},
			"https://github.com/awkhad/zserver/forms":            {"*"},
	...
	result = strings.ReplaceAll(result, "zdb.ZdB", "ZdB")
	result = strings.ReplaceAll(result, "ORIGINAL_CORE_APP", "core.App")
	result = strings.ReplaceAll(result, "ORIGINAL_POCKETBASE", "zdb.ZdB")
