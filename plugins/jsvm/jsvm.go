...
// to the ZdB instance (loading migrations, attaching to app hooks, etc.).
//
// Example:
//
...
import (
	...
	m "https://github.com/awkhad/zserver/migrations"
	"https://github.com/awkhad/zserver/plugins/jsvm/internal/types/generated"
