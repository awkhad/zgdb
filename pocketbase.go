...
import (
	...
	"https://github.com/awkhad/zserver/cmd"
...
// If you want to initialize the application before calling [Start()],
// then you'll have to manually call [Bootstrap()].
func NewWithConfig(config Config) *ZdB {
...
// so we can have all ZdB flags ready for use on initialization.
func (pb *ZdB) eagerParseFlags(config *Config) error {
	pb.RootCmd.PersistentFlags().StringVar(
		&pb.dataDirFlag,
		"dir",
		config.DefaultDataDir,
		"the ZdB data directory",
	)
...
//
// https://https://github.com/awkhad/zserver/issues/404
// https://https://github.com/awkhad/zserver/discussions/1267
func (pb *ZdB) skipBootstrap() bool {
	flags := []string{
		"-h",
		"--help",
		"-v",
