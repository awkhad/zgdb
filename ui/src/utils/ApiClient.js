import ZdB, { LocalAuthStore, isTokenExpired } from "zdb";
// ---
 ...
 */
ZdB.prototype.logout = function(redirect = true) {
 ...
 */
ZdB.prototype.error = function(err, notify = true, defaultMsg = "") {
 ...
 */
ZdB.prototype.getAdminFileToken = async function(collectionId = "") {
    let needToken = true;
